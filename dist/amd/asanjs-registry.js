define(["module", "exports", "core-js", 'process'], function (module, exports, _coreJs) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Registry = exports.ControllerConnector = undefined;
  ...
  (function (process) {
    ...
    if (WebComponents.flags.shadow) {
      ...
      (function (scope) {
        ...
        TouchList.prototype = { item: function item(index) {
            return this[index];
          } };
      ...
      (function (scope) {
        ...
        var MatchesInterface = { matches: function matches(selector) {
      ...
      (function (scope) {
        ...
        var NonElementParentNodeInterface = { getElementById: function getElementById(id) {
      ...
      (function (scope) {
        ...
        mixin(Text.prototype, { splitText: function splitText(offset) {
      ...
      (function (scope) {
        ...
        mixin(HTMLCanvasElement.prototype, { getContext: function getContext() {
      ...
      (function (scope) {
        ...
        mixin(SVGElement.prototype, { get ownerSVGElement() {
        ...
        Document.prototype.createTreeWalker = function (root, whatToShow, filter, expandEntityReferences) {
          ...
          if (filter) {
            if (filter.acceptNode && typeof filter.acceptNode === "function") {
              newFilter = { acceptNode: function acceptNode(node) {
    ...
    (function (global, factory) {
      ...
      var dispatcher = {
        ...
        dispatchEvent: function dispatchEvent(inEvent) {
    ...
    (function () {
      var win = window,
        ...
        return true;
          ...
          regexDigits = /(\d+)/g,
          keypseudo = { action: function action(pseudo, event) {
        ...
        return {
          ...
          _matchSelector = Element.prototype.matches || Element.prototype.matchesSelector || Element.prototype[prefix.lowercase + 'MatchesSelector'];
      var typeCache = {},
          ...
          for (var type in mixin) {
            ...
            if (!original) tag[type] = item;else {
              switch (type) {
                ...
                case 'prototype':
                  for (var z in item) {
                    if (!original[z]) original[z] = item[z];else mergeMixin(tag, original[z], item[z], name);
                  }
                  break;
                default:
      ...
      function delegateAction(pseudo, event) {
        ...
        while (!match && target && target != root) {
          if (target.tagName && _matchSelector.call(target, pseudo.value)) match = target;
          target = target.parentNode;
        }
        if (!match && root.tagName && _matchSelector.call(root, pseudo.value)) match = root;
      ...
      var xtag = {
        ...
        defaultOptions: {
          ...
          lifecycle: {},
          attributes: {},
          'prototype': { xtag: { get: function get() {
                return this.__xtag__ ? this.__xtag__ : this.__xtag__ = { data: {} };
              } } }
        },
        register: function register(name, options) {
          var _name;
          if (typeof name == 'string') _name = name.toLowerCase();else throw 'First argument must be a Custom Element string name';
          ...
          tag.prototype.setAttribute = {
            ...
            value: function value(name, _value) {
              ...
              if (attr) {
                ...
                _value = attr.boolean ? '' : attr.validate ? attr.validate.call(this, _value) : _value;
              }
              modAttr(this, attr, _name, _value, 'setAttribute');
              if (attr) {
                if (attr.setter) attr.setter.call(this, attr.boolean ? true : _value, old);
                syncAttr(this, attr, _name, _value, 'setAttribute');
              }
            }
          };
          ...
          var elementProto = basePrototype ? basePrototype : tag['extends'] ? Object.create(doc.createElement(tag['extends']).constructor).prototype : win.HTMLElement.prototype;
        ...
        customEvents: {
          ...
          tap: {
            ...
            condition: function condition(event, custom) {
              ...
              } else if (event.button === 0 && Math.abs(custom.startX - event.clientX) < 10 && Math.abs(custom.startY - event.clientY) < 10) return true;
            }
          },
          tapstart: {
            attach: ['pointerdown'],
          ...
          taphold: {
            ...
            condition: function condition(event, custom) {
              if (event.type == 'pointerdown') {
                (custom.pointers = custom.pointers || {})[event.pointerId] = setTimeout(xtag.fireEvent.bind(null, this, 'taphold'), custom.duration || 1000);
              } else if (event.type == 'pointerup') {
                if (custom.pointers) {
        ...
        pseudos: {
          __mixin__: {},
          mixins: { onCompiled: function onCompiled(fn, pseudo) {
          ...
          preventable: { action: function action(pseudo, event) {
              return !event.defaultPrevented;
            } },
          duration: { onAdd: function onAdd(pseudo) {
              pseudo.source.duration = Number(pseudo.value);
            } },
          capture: { onCompiled: function onCompiled(fn, pseudo) {
          ...
          if (key.match(':')) {
            ...
            while (i--) {
              parsePseudo(function () {
                ...
                if (!target) pseudo.onAdd.call(fn, pseudo);else target.push(pseudo);
              });
            }
          }
      ...
      if (typeof define === 'function' && define.amd) define(xtag);else if (typeof module !== 'undefined' && module.exports) module.exports = xtag;else win.xtag = xtag;
  ...
  var ControllerConnector = exports.ControllerConnector = function () {
