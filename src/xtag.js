  ...
  (function(global, factory) {
    ...
    var dispatcher = {
      ...
      register: function(element) {
        ...
        for (var i = 0,
            es; (i < l) && (es = this.eventSourceList[i]); i++) {
      ...
      customEvents: {
        ...
        tap: {
          ...
          condition: function(event, custom) {
            ...
            } else if (event.button === 0 && Math.abs(custom.startX - event.clientX) < 10 && Math.abs(custom.startY - event.clientY) < 10)
              return true;
          }
        },
        tapstart: {
        ...
        tapmove: {
          ...
          condition: function(event, custom) {
            if (event.type == 'pointerdown') {
              if (!custom.moveListener)
                custom.moveListener = xtag.addEvent(this, 'pointermove', custom.listener);
